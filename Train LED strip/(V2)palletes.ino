...
{
  // This code takes the readings from the lidar and tells what direction the LED's to go
  
  // uint8_t brightness = 10; // MADE THIS INTO GLOBAL
  // if(lidarReturn < 51 && DIRECTION <= 3)
  //     {
  ...
  //       }
  //     }
  //   else if(lidarReturn > 51 && DIRECTION <= 3)
  //   {
  //     brightness = 250;
  //     DIRECTION = 1;
  //   }
  ...
  //   }
    ...
    // This code decides what direction it goes
